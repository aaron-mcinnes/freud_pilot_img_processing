...
colnames = {'colorspace', 'luminanceMode', 'spectralMode'};
params = table({cs_tag}, {mdLum}, {mdSp}, 'VariableNames', colnames);
disp(params)
writetable(params, fullfile(output_folder, 'DIAGNOSTICS', 'params'), 'Delimiter', ',');
